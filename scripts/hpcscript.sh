...
mpirun --bind-to none -n $SLURM_NTASKS python3 scripts/iceshelf.py --lstar  0.005 --dt 2.5 --height 500 --nondim_length 5 --cellfactor 1.0 --strength_deg 0 --Ttop -5 --Tbot -5 --nt 1500 --relax_time 400 --lfactor 2 --save_bp True
