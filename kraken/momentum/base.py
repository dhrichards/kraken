...
class Momentum:
    ...
    def crack_pressure(self, u):
        ...
        return mf.modified_water_pressure(self.sim.msh, self.sim.params.ρwstar,self.sim.params.ρmstar, self.sim.params.crack_level_star) + self.sim.params.patmstar
